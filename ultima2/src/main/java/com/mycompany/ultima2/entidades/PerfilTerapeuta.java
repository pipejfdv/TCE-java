...
@NamedQueries({
    ...
    @NamedQuery(name = "PerfilTerapeuta.findByGeneroId", query = "SELECT p FROM PerfilTerapeuta p WHERE p.generoId = :generoId"),
...
public class PerfilTerapeuta implements Serializable {
    ...
    public PerfilTerapeuta(Integer id, String primerNombre, String primerApellido, int especialidadId, int generoId, String correo, String contrasena, Date fechaRegistro) {
        this.id = id;
    ...
    public String toString() {
        return "com.mycompany.ultima2.entidades.PerfilTerapeuta[ id=" + id + " ]";
    }
